...
*********************************************************/
uint16_t vaSL01::getUVA(void)
{
	return (uint16_t)abs(UVAintensity);
}

/********************************************************
 	Request UVB data in micoWatts/cm^2
*********************************************************/
uint16_t vaSL01::getUVB(void)
{
	return (uint16_t)abs(UVBintensity);
}

/********************************************************
 	Request ambeint light in LUX
*********************************************************/
uint16_t vaSL01::getLUX(void)
{
	return LUX;
}
...
/********************************************************
 	Request ambeint light in LUX
*********************************************************/
uint8_t vaSL01::getUVIndex(void)
{
	return (uint8_t)abs(UVindex);
}
...
*********************************************************/
void vaSL01::GET_TSL(void) 
{
	uint8_t raw_LUX_L, raw_LUX_H;
...
*********************************************************/
void vaSL01::calculateIndex(void)
{
...
*********************************************************/
void vaSL01::writeVEML(byte reg, byte lowbyte, byte highbyte)
{
...
/********************************************************
 	Read Data from VEML
*********************************************************/
uint16_t vaSL01::readVEML(byte reg)
{
	uint16_t value = 0;
	uint8_t lowByte = 0;
	uint8_t highByte = 0;
