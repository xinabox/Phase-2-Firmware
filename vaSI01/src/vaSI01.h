...
// LSM9DS1 Orientation Registers
#define OUT_X_G_HB			0x19
#define OUT_X_G_LB			0x18
#define OUT_Y_G_HB			0x1A
#define OUT_Y_G_LB			0x1B
#define OUT_Z_G_HB			0x1C
#define OUT_Z_G_LB			0x1D
...
/*---------------------------------------------------------------*/
class vaSI01: public xCoreClass
{
	public:
		/**
		...
		*/	
		vaSI01();
		vaSI01(uint8_t I2C_AG, uint8_t I2C_M);
		...
		* @return none
		*/
		void calibrateMag(bool start);
		
	private:

		void applyOffset(uint8_t a, int16_t offset);
		/*
		* Set the I2C Address 
		*
